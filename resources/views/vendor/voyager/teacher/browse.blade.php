    ...
    <div class="container-fluid">
        <div class="row" style="padding-bottom: 0px">
            <div class="col-md-6" style="margin-bottom: 0px">
                ...
                <a href="{{url('admin/teachers/create')}}" class="btn btn-success btn-add-new">
                                    ...
                                    <tr id="myTable">
                                        ...
                                        <td class="no-sort no-click text-right" id="bread-actions">
                                                ...
                                                <div class="btn-toolbar">
                                                    ...
                                                    <button dataid="{{$teacher->id}}" class="btn btn-danger pull-right customBtn deleteCustom" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{url('admin/teachers/destroy')}}" method="post">
                                                                        {{csrf_field()}}
                                                                        {{method_field('DELETE')}}
                                                    ...
                                                    @endif
                                            <a href='{{url("admin/teachers/{$teacher->id}")}}' class="btn btn-warning pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                <i class="voyager-eye"></i> <span>View</span>
                                            </a>
                                            <a href='{{url("admin/teachers/{$teacher->id}/edit")}}' class="btn btn-primary pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
